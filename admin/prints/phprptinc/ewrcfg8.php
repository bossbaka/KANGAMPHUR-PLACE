...
define("EWR_PROJECT_ID", "{19712832-2D58-4C9F-974D-7D048E8647A4}", TRUE); // Project ID
...
define("EWR_CONN_USER", 'kangamph_db', TRUE);
define("EWR_CONN_PASS", '123456', TRUE);
define("EWR_CONN_DB", 'kangamph_db', TRUE);
...
define("EWR_RANDOM_KEY", 'chHteoc0noBvBPr4', TRUE); // Random key for encryption
